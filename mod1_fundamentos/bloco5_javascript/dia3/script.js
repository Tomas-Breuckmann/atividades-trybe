...
//RESPOSTA: pois ela tem a classe tech que esta com translação y de -20px que a leva para cima
...
input.addEventListener('input', digitacao)
...
function portfolio(event){
    window,open('https://tomas-breuckmann.github.io/')
}

// 5. Crie uma função que, ao passar o mouse sobre 'Meu top 3 do Spotrybefy', altere
// a cor do mesmo;
myWebpage.addEventListener('mouseover',alteraCorOver)
myWebpage.addEventListener('mouseleave',alteraCorLeave)
function alteraCorOver(event){
    myWebpage.style.color='red'
}
function alteraCorLeave(event){
